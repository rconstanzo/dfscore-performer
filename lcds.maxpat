...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1487.0, 118.0, 150.0, 60.0 ],
					"text" : "allow scripting messages to thispatcher to allow the creation of fixed panel/display features"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1393.0, 118.0, 69.0, 20.0 ],
